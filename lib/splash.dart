        ...
        child: Center(
          child: Column(
            ...
            children: [
                ...
                Text('VFX LOGISTICS',style:TextStyle(fontSize: 36,fontWeight: FontWeight.bold,color: Colors.white)),
                SizedBox(
                            height: 10,
                          ),
                Text('....we move anything, seriously.',style:TextStyle(fontSize: 14,color: Colors.white)),
